...
$sql="SELECT count(*) FROM permission where subID ='$sub' and userEmail= '$uname' and hasAccess='Y'";
    ...
    <section class="content">
        ...
        <div class="col-md-12" style="margin-top: 65px;" data-bind="foreach:subcategories">
			...
			<div class="col-sm-12"><a data-bind="attr: { href: link }">
					...
					<h4 class="categoryName" style="font-weight: bold; color: #222;" data-bind="text:subFolderName">Java</h4>
				</a></div>
			</div>
		</div>
	</div>
